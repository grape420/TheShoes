...
<body>
	...
	<section>
		...
		<div class="info-section">
			...
			<div class="info">
				<h1>
					${requestScope.resellDetail.boardTitle}
					</h1>
					<h2></h2>
					<h5>138,000 원</h5>
					<p class="txt">${requestScope.resellDetail.boardContent}
					</p>
			</div>
		</div>
		<div class="comments">
			...
			<div class="area1">
				<div class="write">
					<textarea placeholder="댓글 등록"></textarea>
					<p class="secret-box">
						<input type="checkbox" id="##_guest_input_secret_##"
							name="##_guest_input_secret_##" class="secret-check" value="1">
