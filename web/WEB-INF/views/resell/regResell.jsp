					...
					<div class="right">
						<ul class="img_list">
							<li class="input_img" id="img_body1">
								<img id="img_file1">이미지 등록1<input type="file" name="resellFileName" accept="image/jpg, image/jpeg, image/png" id="resell_img1" onchange="loadImg(this, 1)" required>
							</li>
							<li class="input_img" id="img_body2">
								<img id="img_file2">이미지 등록2<input type="file" name="resellFileName1" accept="image/jpg, image/jpeg, image/png" id="resell_img2" onchange="loadImg(this, 2)" required>
							</li>
							<li class="input_img" id="img_body3">
								<img id="img_file3">이미지 등록3<input type="file" name="resellFileName2" accept="image/jpg, image/jpeg, image/png" id="resell_img3" onchange="loadImg(this, 3)" required>
							</li>
							<li class="input_img mt-4 mr-3" id="img_body4">
								<img id="img_file4">이미지 등록4<input type="file" name="resellFileName3" accept="image/jpg, image/jpeg, image/png" id="resell_img4" onchange="loadImg(this, 4)" required>
							</li>
							<li class="input_img mt-4" id="img_body5">
								<img id="img_file5">이미지 등록5<input type="file" name="resellFileName4" accept="image/jpg, image/jpeg, image/png" id="resell_img5" onchange="loadImg(this, 5)" required>
							</li>
							<li class="input_img mt-4" id="img_body6">
								<img id="img_file6">이미지 등록6<input type="file" name="resellFileName5" accept="image/jpg, image/jpeg, image/png" id="resell_img6" onchange="loadImg(this, 6)" required>
							</li>
