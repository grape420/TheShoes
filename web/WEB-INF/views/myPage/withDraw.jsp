      ...
      <div id="content">
        ...
        <div class="container-fluid container_center">
          ...
          <div class="secession pb-0">
            ...
            <ul class="num_bullet">
              <li data-num="1.">탈퇴 이후에는 참여하신 이벤트의 응모 및 당첨 혜택이 모두 소멸됩니다.</li>
              <li data-num="2.">탈퇴 이후에는 기존 아이디로는 회원가입 및 로그인이 불가합니다.</li>
              <li data-num="3.">탈퇴 이후에는 어떠한 방법으로도 기존의 회원정보를 복원할 수 없습니다.</li>
              <li data-num="4.">전자상거래 등에서의 소비자보호법에 관한 법률에 따라 계약 또는 청약철회에 관한 기록, 대금 결제 및 재화 등의 <br />공급에 관한 기록은 5년, 그리고
