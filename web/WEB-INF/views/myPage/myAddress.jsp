...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${ pageContext.servletContext.contextPath }/resources/css/myPage/myAddress.css">
									...
									<div class="contents">
										<div class="address-form"
											...
											<form class="manage-account" method="POST" action=""
												...
												<input type="button" onclick="" class="btn_search" value="검색">
						...
						<div class="address-form">
							<form class="manage-account" method="POST" action=""
								...
								<input required type="text" name="address1" id="address1"
									class="form-control address-search" placeholder="예) 사랑시 고백구 행복동"> <input
									type="hidden" id="address3" name="address.addressLine3"
									value=""> <input type="hidden" id="addr_save_fild">
								<input type="button" onclick="" class="btn_search" value="검색">
