...
//			
//			String fileUploadDirectory = rootLocation + "/resources/upload/image/sample";
...
//		java.sql.Date winnerDate = java.sql.Date.valueOf(request.getParameter("winnerDate"));
...
//		java.sql.Date endDate = java.sql.Date.valueOf(request.getParameter("endDate"));
		...
		shoes.setShoesModel(shoesModel);
		shoes.setShoesPrice(shoesPrice);
//		shoes.setWinnerDate(winnerDate);
		shoes.setSalesYn(salesYn);
		shoes.setSalesAmount(salesAmount);
//		shoes.setStartDate(startDate);
//		shoes.setEndDate(endDate);
