...
public class WinnerDTO implements Serializable{
	...
	public WinnerDTO(int winnerNo, String memberId, String deliveryDetail, String name, String shoesModel,
			int shoesPrice, String enventStatus) {
		...
		this.enventStatus = enventStatus;
	}
	...
	public String getEnventStatus() {
		return enventStatus;
	}
	public void setEnventStatus(String enventStatus) {
		this.enventStatus = enventStatus;
	}
	...
	public String toString() {
		return "WinnerDTO [winnerNo=" + winnerNo + ", memberId=" + memberId + ", deliveryDetail=" + deliveryDetail
				+ ", name=" + name + ", shoesModel=" + shoesModel + ", shoesPrice=" + shoesPrice + ", enventStatus="
				+ enventStatus + "]";
	}
