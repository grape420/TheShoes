...
public class BoardAndCommentsDTO implements Serializable{

	private static final long serialVersionUID = -3418661020808361565L;
	...
	public BoardAndCommentsDTO() {
	}
	public BoardAndCommentsDTO(int boardNo, String boardId, int boardCategoryNo, String boardTitle, String boardContent,
	...
	public String toString() {
		return "BoardAndCommentsDTO [boardNo=" + boardNo + ", boardId=" + boardId + ", boardCategoryNo="
				+ boardCategoryNo + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent + ", boardRegDate="
