...
public class CommentsDTO implements Serializable{
	...
	public CommentsDTO(int commentsNo, int boardNo, String commentsContent, String commentsYn, Date commentsRegDate) {
	...
	public String toString() {
		return "CommentsDTO [commentsNo=" + commentsNo + ", boardNo=" + boardNo + ", commentsContent=" + commentsContent
				+ ", commentsYn=" + commentsYn + ", commentsRegDate=" + commentsRegDate + "]";
	}
